...
Page({
  ...
  onLoad: function (options) {
    ...
    httpClient.send(request.url.queryUpdatingGroups, "GET", {});
  ...
  nextPage: function () {
    ...
    httpClient.send(request.url.nextUpdatingGroups, "GET", {  page: that.data.page });
  ...
  approvePass:function(res){
    ...
    httpClient.send(request.url.passUpdatingGroup, "GET", {groupId:group.groupId});
