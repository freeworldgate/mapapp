...
Page({
  ...
  queryInvites:function (tab,userId) {
    var that = this;
    var httpClient = template.createHttpClient(that);
    httpClient.setMode(tab, false);
    httpClient.send(request.url.queryUserPublishPks, "GET", { userId:userId });
  ...
  onReachBottom: function () {
    var that = this;
      ...
      httpClient.send(request.url.nextUserPublishPks, "GET",{ userId:that.data.targetUserId,page:that.data.page});
